...
{
    public abstract class EventTask8
    {
        public string EventName { get; set; }
        public DateTime EventDate { get; set; }
        public TimeSpan EventTime { get; set; }
        public VenueTask8 Venue { get; set; }  // Has A relation with Venue
        ...
        // Constructor
        protected EventTask8(string eventName, DateTime eventDate, TimeSpan eventTime, VenueTask8 venue, int totalSeats, decimal ticketPrice, string eventType)
        {
            EventName = eventName;
            EventDate = eventDate;
            EventTime = eventTime;
    ...
    public class MovieTask8 : EventTask8
    {
        public string Genre { get; set; }
        public string ActorName { get; set; }
        public string ActressName { get; set; }

        public MovieTask8(string eventName, DateTime eventDate, TimeSpan eventTime, VenueTask8 venue, int totalSeats, decimal ticketPrice, string genre, string actorName, string actressName)
    ...
    public class ConcertTask8 : EventTask8
    {
        public string Artist { get; set; }
        public string Type { get; set; }

        public ConcertTask8(string eventName, DateTime eventDate, TimeSpan eventTime, VenueTask8 venue, int totalSeats, decimal ticketPrice, string artist, string type)
    ...
    public class SportsTask8 : EventTask8
    {
        public string SportName { get; set; }
        public string TeamsName { get; set; }

        public SportsTask8(string eventName, DateTime eventDate, TimeSpan eventTime, VenueTask8 venue, int totalSeats, decimal ticketPrice, string sportName, string teamsName)
